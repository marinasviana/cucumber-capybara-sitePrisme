# _______________Dado____________

Dado(/^que o usuário esteja na página para envio de um comentário$/) do
...
# _______________Quando____________
...
# _______________Entao____________

Dado("que eu esteja na home de cadastro") do
...
Quando("quando o usuário clica em Enviar Cadastro") do
  @cadastros.envia_cadastro()
  @cadastro_concluido = ResultadoBusca.new
end

Então("ele deve ser redirecionado para a página de Cadastro concluída") do
